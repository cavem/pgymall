...
$(function(){
    ...
    var sentkv=function(){
        ...
        var area=$('.area').find('.onthis').data('val');var areaarr=new Array("宿迁多线","宿迁三线BGP","广州多线","镇江多线");//地区
                        ...
                        <div class="panelcon">
                            <div class="list">
                                ...
                                <ul class="area">
                                    ...
                                    <li class="gzdx" data-val="2">广州多线</li>
                                    <li class="zjdx" data-val="3">镇江多线</li>
                                </ul>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="haveborder">
                        ...
                        <div class="panelcon">
                            <div class="list">
                                ...
                                <ul class="cpu">
                                    <li class="onthis" data-type="cpu" data-val="16核L5630*2">16核L5630*2</li>
                                    <li data-type="cpu" data-val="24核E5-2430*2">24核E5-2430*2</li>
                                    <li data-type="cpu" data-val="24核E5-2450*2">24核E5-2450*2</li>
                                    <li data-type="cpu" data-val="32核E5-2670*2">32核E5-2670*2</li>
                                </ul>
                            </div>
                            <div class="list">
                                ...
                                <ul class="mmr">
                                    <div class="selecon" style="width:125px;float:left;">
                                        <select class="form-control select-mmr">
                    ...
                    <td class="haveborder">
                        ...
                        <div class="panelcon">
                            <div class="list">
                                ...
                                <ul class="ssd">
                                    <li class="onthis" data-type="ssd" data-val="120">120G固态</li>
                                    <li data-type="ssd" data-val="240">240G固态</li>
                                    <li data-type="ssd" data-val="500">500G机械</li>
                                    <li data-type="ssd" data-val="1000">1T机械</li>
                                    <li data-type="ssd" data-val="2000">2T机械</li>
                                </ul>
                            </div>
                        </div>
                    </td>
