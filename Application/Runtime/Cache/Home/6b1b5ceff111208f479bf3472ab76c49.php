...
<div class="banner">
    <div class="banner-contain w1200 pr">
        ...
        <div class="bc-right tl pa" style="left:200px;top:20px;">
            ...
            <p class="mt20 wow fadeInUp">下载中心下载中心下载中心下载中心下载中心</p>
        </div>
    </div>
</div>
        ...
        <ul id="accordion" class="accordion">
            ...
            <li class="open">
                ...
                <ul class="submenu" style="display: block;">
                    <li><a href="/Application/Home/View/Public/files/20170204132851_8731.docx">服务器租用合同 <span class="fa fa-cloud-download"></span></a></li>
                    <li><a href="/Application/Home/View/Public/files/20170204132851_8702.docx">服务器托管合同 <span class="fa fa-cloud-download"></span></a></li>
        ...
        <div class="accordion-contain">
            <div class="accordioncontain-item">
                <a href="">
                    ...
                    <p class="title">服务器租用合同</p>
                    <p class="title"><a href="/Application/Home/View/Public/files/20170204132851_8731.docx"><i class="fa fa-cloud-download"></i> 下载</a></p>
                </a>
            </div>
            <div class="accordioncontain-item">
                <a href="">
                    <i class="fa fa-file-text-o" style="font-size:100px;color:#60aff6;"></i>
                    <p class="title">服务器托管合同</p>
                    <p class="title"><a href="/Application/Home/View/Public/files/20170204132851_8702.docx"><i class="fa fa-cloud-download"></i> 下载</a></p>
                </a>
            </div>
            <!-- <div class="accordioncontain-item">
                <a href="">
