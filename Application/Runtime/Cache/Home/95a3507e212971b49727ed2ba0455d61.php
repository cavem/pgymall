...
<style>
    ...
    .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th{padding:12px 40px;}
...
<div class="banner">
    <div class="banner-contain w1200 pr">
        <div class="bc-left"><span class="circle1"></span><span class="circle2"></span><img src="/Application/Home/View/Public/images/area.png"></div>
        <div class="bc-right tl pa" style="left:200px;top:20px;">
            <h2 class="m0 wow fadeInUp">最新产品</h2>
            <p class="mt20 wow fadeInUp">我们是国内高标准建设的T3级机房，现有面积为50000平方米，机架总数20000余个，双路独享变电所接入，油机保证。华东地区第一家带防BGP，国家甲级机房，超级数据港。专门技术人员7X24小时维护;标准机房环境，提供365天全天候运营服务。</p>
            <div class="show-more m0 mt30 wow fadeInUp askbtn">立即咨询</div>
            <a href="<?php echo U('Index/serverbuy');?>"><div class="show-more m0 mt30 wow fadeInUp">立即购买</div></a>
        </div>
    </div>
</div>
...
<!-- <div class="small-banner">
    <div class="smban-contain w1200" style="height:60px;">
        <ul class="ul-smbancon">
            <li><a href="<?php echo U('Index/sqidc');?>">宿迁机房</a></li>
            <li><a href="<?php echo U('Index/jdidc');?>">京东机房</a></li>
            <li><a href="<?php echo U('Index/wzidc');?>">温州机房</a></li>
            <li><a class="currenton" href="<?php echo U('Index/gzidc');?>">广州机房</a></li>
        </ul>
    </div>
</div> -->
...
<div class="main-contain">
    <div class="w1200 pt25 pb25 bborder">
        <h3 class="main-h3 pt20 pb20">产品介绍</h3>
        <p class="main-p tl pt20 pb20">600G电信出口，160G联通出口，10G江苏移动出口，BGP协议三线接入，可以和其他运营商互联互通，轻松实现单IP多线路，所有运营商用户快速访问，低延时，这是传统双线双IP不能实现的，另扬州电信有10G互联链路。60G基础防御的全业务阻断国外流量，单点防护可以达到500G，让你的服务器稳如泰山！
        </p>
        </br>
        <ul class="main-ul">
            <li><img src="/Application/Home/View/Public/images/cpys1.png"></li>
            <li><img src="/Application/Home/View/Public/images/cpys2.png"></li>
            <li><img src="/Application/Home/View/Public/images/cpys3.png"></li>
            <li><img src="/Application/Home/View/Public/images/cpys4.png"></li>
            <li><img src="/Application/Home/View/Public/images/cpys5.png"></li>
            <li><img src="/Application/Home/View/Public/images/cpys6.png"></li>
            <li><img src="/Application/Home/View/Public/images/cpys7.png"></li>
        </ul>
    </div>
    <div class="w1200 pt25 pb25 bborder">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <td rowspan="2" style="vertical-align: middle;">弹性</td>
                    <td>自定义服务器配置</td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                </tr>
                <tr>
                    <td>集群快速扩容</td>
                ...
                <tr>
                    <td rowspan="2" style="vertical-align: middle;">易用</td>
                    <td>快速交付</td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                </tr>
                ...
                <tr>
                    <td rowspan="2" style="vertical-align: middle;">全面</td>
                    <td>跨地域数据中心互通</td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                </tr>
                ...
                <tr>
                    <td rowspan="2" style="vertical-align: middle;">省心</td>
                    <td>硬件故障直接替换</td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                </tr>
                ...
                <tr>
                    <td rowspan="2" style="vertical-align: middle;">节省</td>
                    <td>包年包月，按需购买</td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                    <td><i class="fa fa-check" style="color: #60aff6;"></i></td>
                </tr>
    ...
    <div class="w1200 pt25 pb25 bborder">
        ...
        <ul class="main-ulscene">
            <li class="fl active"><img src="/Application/Home/View/Public/images/web.png"><span class="scene-span">大型网站</span></li>
            <li class="fr"><img src="/Application/Home/View/Public/images/game.png"><span class="scene-span">游戏</span></li>
        </ul>
        <div class="main-conscene">
            <div class="conscene-web p50">
                <p class="tl" style="font-size: 16px;">适用对象：社区SNS/论坛/ERP/OACRM</p>
                ...
                <div class="tl initial">
                    ...
                    <span class="initial-item"><span>24核E5-2430*2</span><span>cpu</span></span>
                    <span class="initial-item"><span>32G</span><span>内存</span></span>
                    <span class="initial-item"><span>50M</span><span>带宽</span></span>
                    <span class="initial-item"><span>240G固态</span><span>存储</span></span>
                    <a href="<?php echo U('Index/serverbuy');?>"><button class="btn btn-default">立即购买</button></a>
                </div>
            </div>
            <div class="conscene-game p50" style="display:none;">
                <p class="tl" style="font-size: 16px;">适用对象：网络游戏等其他高端服务</p>
                <p class="tl" style="color: #888;line-height: 2em;">适合对计算性能要求较高的应用场景，如企业运营活动、批量处理、分布式分析、游戏app等。
                        <span style="color: #60aff6">网络游戏在近年来发展迅速，除了传统网络终端之外，网页游戏、手机游戏等发展迅速，也让整个游戏市场愈发壮大。</span></p>
                <div class="tl initial">
                    <span class="initial-title">推荐配置:</span>
                    <span class="initial-item"><span>32核E5-2670*2</span><span>cpu</span></span>
                    <span class="initial-item"><span>64G</span><span>内存</span></span>
                    <span class="initial-item"><span>100M</span><span>带宽</span></span>
                    <span class="initial-item"><span>240G固态</span><span>存储</span></span>
                    <a href="<?php echo U('Index/serverbuy');?>"><button class="btn btn-default">立即购买</button></a>
                </div>
            </div>
    ...
    <div class="w1200 pt25 pb25 bborder">
        <h3 class="main-h3 pt20 pb20">推荐产品</h3>
        <div class="commend-item-wrap clearfix">
            <div class="commend-item">
                <div class="commend-item-intro" id="g6s">
                    <h4 class="commend-item-title">产品型号：</h4>
                    <div class="info-line clearfix ">
                        <span class="introlabel">CPU：</span>
                        <span class="text">16核L5630*2</span>
                    </div>
                    <div class="info-line clearfix ">
                        <span class="introlabel">内存：</span>
                        <span class="text">32G</span>
                    </div>
                    <div class="info-line clearfix ">
                        <span class="introlabel">硬盘：</span>
                        <span class="text">240G固态*2</span>
                    </div>
                    <div class="info-line clearfix ">
                        <span class="introlabel">公网带宽：</span>
                        <span class="text">20Mbps</span>
                    </div>
                    <div class="info-line clearfix ">
                        <span class="introlabel">公网IP：</span>
                        <span class="text">1个</span>
                    </div>
                    <div class="info-line clearfix  selected-line ">
                        <span class="introlabel">线路：</span>
                        <span class="text"></span>
                    </div>
                </div>
                <div class="commend-item-btn-wrap">
                    <a href="http://crm2.qq.com/page/portalpage/wpa.php?uin=800002004&aty=0&a=0&curl=&ty=1" target="_blank" class="commend-item-btn" id="xujnxmpb">立即咨询</a>
                    <a href="<?php echo U('Index/serverbuy');?>" target="_blank" class="commend-item-btn">更多选择</a>
                </div>
            </div>
            <div class="commend-item">
                <div class="commend-item-intro" id="g6s">
                    ...
                    <div class="info-line clearfix ">
                        <span class="introlabel">CPU：</span>
                        <span class="text">24核E5-2430*2</span>
                    </div>
                    <div class="info-line clearfix ">
                        <span class="introlabel">内存：</span>
                        <span class="text">32G</span>
    ...
    <div class="w1200 pt25 pb25">
        <h3 class="main-h3 pt20 pb20">机房展示</h3>
        <div style="width:100%;"><img style="width:100%;" src="/Application/Home/View/Public/images/bangongshi1.jpg"></div>
    </div>
</div>
<script>
    $(function(){
