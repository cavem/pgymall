...
<style>
    .newslist{text-align: left;padding: 30px 0;}
    .newslist dl{display: block;margin-bottom: 30px;}
    .newslist dl dt{width: 100%;display: inline-block;border-bottom: 1px dashed #cfcfcf;line-height: 28px;font-size: 18px;padding-bottom: 6px;margin-bottom: 10px;}
    .newslist dl dd{line-height: 24px;color: #666;background-color: #f8f7f7;}
</style>
<div class="banner">
    <div class="banner-contain w1200 pr">
        <div class="bc-left"><span class="circle1"></span><span class="circle2"></span><img src="/Application/Home/View/Public/images/news.png"></div>
        <div class="bc-right tl pa" style="left:200px;top:20px;">
            <h2 class="m0 wow fadeInUp">新闻动态</h2>
            <p class="mt20 wow fadeInUp">新闻动态新闻动态新闻动态新闻动态新闻动态新闻动态</p>
        </div>
    </div>
</div>
<div class="news">
    <div class="newslist w1200">
        <dl>
            <dt><a href="<?php echo U('Index/newscontain');?>" target="_blank">新闻标题1！！！</a><span class="time">2018-04-07</span></dt>
            <dd>新闻简述</dd>
        </dl>
    </div>
</div>
