...
.accordioncontain-item .title{color: #424242;font-size: 16px;margin-top:30px;}
...
<div class="banner">
    <div class="banner-contain w1200 pr">
        ...
        <div class="bc-right tl pa" style="left:200px;top:20px;">
            <h2 class="m0 wow fadeInUp">文档中心</h2>
            <p class="mt20 wow fadeInUp">文档中心文档中心文档中心文档中心文档中心</p>
        </div>
    </div>
</div>
        ...
        <div class="accordion-contain">
            <div class="accordioncontain-item">
                <a href="">
                    ...
                    <p class="title">帮助文档1</p>
                </a>
            </div>
            <div class="accordioncontain-item">
                <a href="">
                    <i class="fa fa-file-text-o" style="font-size:100px;color:#60aff6;"></i>
                    <p class="title">帮助文档2</p>
                </a>
            </div>
            <div class="accordioncontain-item">
                <a href="">
                    <i class="fa fa-file-text-o" style="font-size:100px;color:#60aff6;"></i>
                    <p class="title">帮助文档3</p>
                </a>
            </div>
            <div class="accordioncontain-item">
                <a href="">
                    <i class="fa fa-file-text-o" style="font-size:100px;color:#60aff6;"></i>
                    <p class="title">帮助文档4</p>
                </a>
            </div>
        </div>
    </div>
