...
<div class="banner">
    <div class="banner-contain w1200 pr">
        ...
        <div class="bc-right tl pa" style="left:200px;top:20px;">
            <h2 class="m0 wow fadeInUp">云虚拟主机</h2>
            ...
            <div class="show-more m0 mt30 wow fadeInUp">立即购买</div>
        </div>
    </div>
</div>
<!--左右悬浮-->
...
<div class="footer_big">
    ...
    <div id="rfloat" style="position:fixed;top:454px;right:20px;width:84px;height:224px;z-index:999;">
    ...
    <div id="lfloat" style="position:fixed;top:454px;left:20px;width:84px;height:224px;z-index:999;">
