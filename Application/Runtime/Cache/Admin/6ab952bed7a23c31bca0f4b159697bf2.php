                    ...
                    <table class="table table-bordered" style="width: 600px;">
                        <tbody>
                          <tr>
                            ...
                            <td width="400px;"><input class="form-control" placeholder="请输入IP地址"></td>
                          </tr>
                          <tr>
                            <td class="tr">牵引时间（分）：</td>
                            <td><input type="text" class="form-control" style="width: 200px;display: inline-block;" placeholder="请输入牵引时间">(最大设置3天=4320分钟)</td>
                          </tr>
                          <tr>
                            <td class="tr">备注信息：</td>
                            <td><textarea class="form-control" rows="2" placeholder="请输入原因"></textarea></td>
                          </tr>
                        </tbody>
                      </table>
                      <button class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> 新增</button>
                </div>
            </div>
        </div>
    </div>
