            ...
            <div class="info-center">
                ...
                <div class="page-body">
                    ...
                    <div class="btn-group" style="float: right;margin-bottom: 20px;">
                        <a href="admincdmg.html"><button type="button" class="btn btn-default">进入后台管理</button></a>
                    </div>
                    <table class="table table-condensed" style="margin-top: 20px;">
                        ...
                        <tbody>
                            <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                                ...
                                <td>VPS<?php echo ($v["vid"]); ?></td>
                                <td><?php echo ($v["vcpu"]); ?> CPUs, <?php echo ($v["vram"]); ?>M Ram, <?php echo ($v["vdisk"]); ?>G Disk, <?php echo ($v["vip"]); ?>, <?php echo ($v["vos"]); ?></td>
                                <td><?php echo ($v["price"]); ?></td>
                                <td><?php echo (date("y-m-d",$v["duetime"])); ?></td>
                                <td><?=$type[$v['vstatus']]?></td>
                                <td><?php echo ($v['autorenew']==0?'自动':'手动'); ?></td>
                                <td style="text-align: right;"><a href="<?php echo U('Cloud/manageup',array('vid'=>$v['vid']));?>"><button class="btn btn-primary btn-sm">管理</button></a></td>
