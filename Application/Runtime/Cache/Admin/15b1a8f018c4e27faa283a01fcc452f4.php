        ...
        <div class="container-fluid">
            <div class="info-center">
                <div class="page-header">
                    <div class="pull-left">
                        <h4>防火墙相关设置 ＞ 域名白名单(扬州)</h4>      
                    </div>
                </div>
                <div class="page-body">
                    <h4 style="font-weight: bold;margin: 0 auto 35px;">添加防火墙域名白名单(扬州)</h4>
                    <span>域名（单个一行） :</span><input class="form-control" placeholder="请输入域名" style="width: 180px;display: inline-block;">
