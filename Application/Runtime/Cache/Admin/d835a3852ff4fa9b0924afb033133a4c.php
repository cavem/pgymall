             ...
             <div class="topbar-nav-col">
               ...
               <div class="">
                  ...
                  <ul>
                    <li><a href="<?php echo U('Officweb/cloudlist');?>">
                        <span class="glyphicon glyphicon-tags"></span> 
                        <span class="">防御阻断国外IP</span> 
                    </a>
                    </li>
                      <li><a href="<?php echo U('Officweb/serverlist');?>">
                        <span class="glyphicon glyphicon-tags"></span> 
                        <span class="">防御阻断国外IP（包含港澳台）</span> 
                    </a>
                    </li>
                      <li><a href="<?php echo U('Officweb/physicslist');?>">
                        <span class="glyphicon glyphicon-tags"></span> 
                        <span class="">防御不阻断国外IP</span> 
                    </a>
                    </li>
                    <li><a href="<?php echo U('Officweb/serverlist');?>">
                        <span class="glyphicon glyphicon-tags"></span> 
                        <span class="">防御阻断UDP</span> 
                    </a>
                    </li>
                    <li><a href="<?php echo U('Officweb/serverlist');?>">
                        <span class="glyphicon glyphicon-tags"></span> 
                        <span class="">防御阻断UDP及国外IP</span> 
                    </a>
                    </li>
                    <li><a href="<?php echo U('Officweb/serverlist');?>">
                        <span class="glyphicon glyphicon-tags"></span> 
                        <span class="">防御关闭</span> 
                    </a>
                    </li>
                    <li><a href="<?php echo U('Officweb/serverlist');?>">
                        <span class="glyphicon glyphicon-tags"></span> 
  ...
  <div class="right-product right-full">
        ...
        <div class="container-fluid">
          <div class="info-center">
            ...
            <form action="<?php echo U('Officweb/cloudlist');?>" method="post">
            ...
            <div class="clearfix"></div>
              <ul class="nav nav-tabs" role="tablist">  
                <?php if(is_array($cl)): foreach($cl as $key=>$c): ?><li role="presentation" <?=$c['id']==$fid?"class='active'":""?>><a href="<?php echo U('Officweb/cloudlist',array('fid'=>$c['id']));?>" role="tab"><?php echo ($c["title"]); ?></a></li><?php endforeach; endif; ?>
                <!-- <li role="presentation" <?=empty($fid)?"class='active'":""?>><a href="<?php echo U('Officweb/cloudlist',array('fid'=>0));?>" role="tab" >BGP云主机</a></li>  
                <li role="presentation" <?=$fid==1?"class='active'":""?>><a href="<?php echo U('Officweb/cloudlist',array('fid'=>1));?>" role="tab" >单线云主机</a></li>
                <li role="presentation" <?=$fid==2?"class='active'":""?>><a href="<?php echo U('Officweb/cloudlist',array('fid'=>2));?>" role="tab" >高防云主机</a></li>  -->
              </ul>  
                            ...
                            <tbody>
                                <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                                    ...
                                    <td style="white-space:nowrap;">
                                      <a href="<?php echo U('Officweb/cloudinfo',array('cid'=>$v['cid'],'fid'=>$fid));?>"><span class="glyphicon glyphicon-pencil"></span> 编辑</a>
