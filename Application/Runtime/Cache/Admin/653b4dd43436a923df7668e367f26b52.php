  ...
  <div class="right-product right-full">
        ...
        <div class="container-fluid">
          <div class="info-center">
            ...
            <form action="<?php echo U('Officweb/memberlist');?>" method="post">
            ...
            <div class="clearfix"></div>
              ...
              <table class="table table-bordered table-header">
                 ...
                 <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                    ...
                    <td><?php echo ($v["linkmail"]); ?></td>
                    <td style="white-space:nowrap;">
                      <a href="javascript:void(0);" class="btn-balance btn btn-info btn-xs" data="<?=$v['userid']?>"><span class="glyphicon glyphicon-usd"></span> 余额管理</a>
                      <a onclick="return confirm('确定删除?');" href="<?php echo U('Officweb/memberdel',array('id'=>$v['userid']));?>" class="btn btn-xs  btn-danger"><span class="glyphicon glyphicon-trash"></span> 删除</a>
                    </td>
  ...
  $(".btn-balance").click(function(){
      var id=$(this).attr("data");
          layer.open({
            ...
            maxmin: true, //开启最大化最小化按钮
            area: ['420px', '300px'],
            content: '/Admin/Officweb/payinfo?userid='+id
          });
  })
</script>