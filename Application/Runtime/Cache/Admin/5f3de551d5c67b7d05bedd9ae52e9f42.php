  ...
  <div class="right-product right-full">
        ...
        <div class="container-fluid">
          <div class="info-center">
            ...
            <form action="<?php echo U('Officweb/newslist');?>" method="post">
               ...
               <div class="form-group btn-search">
                ...
                <div class="col-md-4">
                 <div class="btn-group pull-right" role="group" aria-label="...">
                  <a type="button" href="<?php echo U('Officweb/newsinfo');?>" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span> 新增</a>
                </div>
                </div>
            </div>
            </form>
              ...
              <table class="table table-bordered table-header">
                 ...
                 <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                    ...
                    <td style="white-space:nowrap;">
                      <a type="button" href="<?php echo U('Officweb/newsinfo',array('id'=>$v['id']));?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span> 编辑</a>
                      <a type="button" onclick="return confirm('确定删除?');" href="<?php echo U('Officweb/newsdel',array('id'=>$v['id']));?>" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span> 删除</a>
                    </td>
