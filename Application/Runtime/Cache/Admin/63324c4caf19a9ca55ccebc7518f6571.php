        ...
        <div class="container-fluid">
            <div class="info-center">
                ...
                <div class="page-body">
                    ...
                    <span>IP :</span><input class="form-control" placeholder="请输入IP地址" style="width: 150px;display: inline-block;">
                    <select class="form-control" style="width: 250px;display: inline-block;font-size: 12px;">
                        <option value="1">默认防护</option>
                        ...
                        <option value="6">Game防护中（传奇类）</option>
                        <option value="7">Game防护高（传奇类）</option>
                        <option value="10">Game防护（DNF+MC）</option>
                        <option value="14">Steam游戏策略</option>
                        <option value="13">UDP目的限速200</option>
                    </select>
                    <span>释放时间：</span>
