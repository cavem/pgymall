...
$(function(){
    ...
    $("input[name='buytime']").val($('.buytime').val());
    //上传图片
    ...
    <form class="mform">
        <div class="form-line w50 fl">
            ...
            <div class="form-content" title="按住ctrl多选" style="width: 250px;">
                <span class="moreoption form-control" style="display: inline-block;overflow: hidden;position: relative;line-height: 1.6;top:3px;"><?php echo ($proinfo["type"]); ?><i class="fa fa-sort-desc fr" style="position: absolute;top: 10px;right: 5px;"></i></span>
                ...
                <input name="type" type="hidden" value="<?php echo ($proinfo["type"]); ?>">    
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">产品名称：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="name" value="<?php echo ($proinfo["name"]); ?>">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">生产厂家：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="vender" value="<?php echo ($proinfo["vender"]); ?>">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">年份：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="time" value="<?php echo ($proinfo["time"]); ?>">
            </div> 年
        </div>
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <select class="form-control" name="smell">
                    ...
                    <?php if(is_array($smelllist)): foreach($smelllist as $key=>$vo): ?><option <?php if($vo['smell']==$proinfo['smell']){echo 'selected';} ?>><?php echo ($vo["smell"]); ?></option><?php endforeach; endif; ?>
                </select>
            </div>
        </div>
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <select class="form-control" name="standard">
                    <option value="">--请选择--</option>
                    <option selected><?php echo ($proinfo["standard"]); ?></option>
                </select>
            </div>
        </div>
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <select class="form-control" name="line">
                    <option value="">--请选择--</option>
                    <option <?php if($proinfo["line"] == '完美'): ?>selected<?php endif; ?>>完美</option>
                    <option <?php if($proinfo["line"] == '合格'): ?>selected<?php endif; ?>>合格</option>
                    <option <?php if($proinfo["line"] == '喝品'): ?>selected<?php endif; ?>>喝品</option>
                    <option <?php if($proinfo["line"] == '废品'): ?>selected<?php endif; ?>>废品</option>
                </select>
            </div>
        </div>
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="degree" value="<?php echo ($proinfo["degree"]); ?>">
            </div>度
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">购买时间：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="buytime" value="<?php echo ($proinfo["buytime"]); ?>">
                <input class="buytime" type="hidden" value="<?php echo ($proinfo["buytime"]); ?>">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">购买人：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="buyperson" value="<?php echo ($proinfo["buyperson"]); ?>">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">购买价格：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="price" value="<?php echo ($proinfo["price"]); ?>">
            </div> 元
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">销售价格：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="saleprice" value="<?php echo ($proinfo["saleprice"]); ?>">
            </div> 元
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">数量：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="num" value="<?php echo ($proinfo["num"]); ?>">
            </div> 瓶
        </div>
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <select class="form-control" name="status">
                    <option value="">--请选择--</option>
                    <option <?php if($proinfo["status"] == '库存'): ?>selected<?php endif; ?>>库存</option>
                    <option <?php if($proinfo["status"] == '喝掉'): ?>selected<?php endif; ?>>喝掉</option>
                    <option <?php if($proinfo["status"] == '送人'): ?>selected<?php endif; ?>>送人</option>
                </select>
            </div>
        </div>
        <div class="form-line fl" style="height: 74px;">
            ...
            <div class="form-content" style="width: 700px;">
                <textarea class="form-control" rows="3" name="descr"><?php echo ($proinfo["descr"]); ?></textarea>
            </div>
        </div>
        <div class="form-line fl">
            <span class="form-label">产品图片：</span>
            <div class="form-content" style="width:618px;">
                <input type="text" name="img" class="form-control" readonly value="<?php echo ($proinfo["img"]); ?>">
            </div>
            <a class="btn btn-primary upload" style="position: relative;bottom: 1px;">上传</a>
        </div>
        <img class="idimg" style="margin-left:150px;max-height: 150px;display: block;" src="<?php echo ($proinfo["img"]); ?>">
    </form>
