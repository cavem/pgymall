            ...
            <div class="info-center">
                ...
                <div class="page-body">
                    <div class="search-header">
                        ...
                        <input type="text" class="form-control" placeholder="请输入要查询的IP" style="width: 200px;display: inline-block;">
                        <button class="btn btn-primary"><i class="glyphicon glyphicon-search"></i> 搜索</button>
                    </div>
                    <div class="server-body">
                        <table class="table table-condensed" style="margin-top: 20px;width:680px;">
                            <thead>
                                <tr style="background: #09c;color: #fff;">
                                    <th width="340px;">IP地址</th>
                                    <th width="340px;">带宽限制</th>
                                </tr>
                            </thead>
                            <tbody>
