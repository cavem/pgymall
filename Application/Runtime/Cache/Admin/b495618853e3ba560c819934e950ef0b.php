...
/* .control-btn-wrap span{padding: 4px 6px;border: 1px solid #d4d4d4;color: #60aff6;cursor: pointer;margin-right: 10px;}
.control-btn-wrap span:hover{border: 1px solid #60aff6;background: #ecf6ff;}
...
.check_span--checked{
    border-color: #60aff6;
    background: url('/Application/Admin/View/Public/img/checked.png') no-repeat;
            ...
            <div class="info-center">
                ...
                <div class="page-body">
                    <div class="btn-group" style="float: right;margin-bottom: 20px;">
                        <a href="<?php echo U('Cloud/cloudmanage');?>"><button type="button" class="btn btn-default">进入前台管理</button></a>
                    </div>
                    <table class="table table-condensed" style="margin-top: 20px;">
                        ...
                        <tbody>
                            <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                                ...
                                <td>VPS<?php echo ($v["cloudno"]); ?></td>
                                <td><?php echo ($v["disprice"]); ?></td>
                                <td><?php echo (date("Y/m/d",$v["buytime"])); ?> - <?php echo (date("Y/m/d",$v["duetime"])); ?></td>
                                <td><?php echo ($v["state"]); ?></td>
                                <td><?php echo ($v["remarks"]); ?></td>
                                <td style="text-align: right;">
                                    <button onclick="proeditopen(<?php echo ($v["cloudno"]); ?>,<?php echo ($v["sid"]); ?>);" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i> 编辑</button>
                                    <a href="<?php echo U('Cloud/manageup',array('vid'=>$v['cloudno']));?>"><button class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-th-list"></i> 管理</button></a>
                                </td>
