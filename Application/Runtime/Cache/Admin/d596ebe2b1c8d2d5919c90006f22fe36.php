        ...
        <div class="container-fluid">
            <div class="info-center">
                ...
                <div class="page-body">
                    ...
                    <span>防御类型：</span>
                    <select class="form-control" style="width: 250px;display: inline-block;font-size: 12px;">
                        <option value="1">防御及阻断国外IP(不包含港澳台)</option>
                        <option value="2">防御及阻断国外IP(包含港、澳、台)</option>
                        <option value="3">防御不阻断国外IP</option>
                        <option value="4">防御阻断UDP</option>
                        <option value="12">防御阻断UDP及国外IP</option>
                        <option value="11">防御关闭</option>
                    </select>
                    <span class="ml15">IP :</span><input class="form-control" placeholder="请输入IP地址" style="width: 180px;display: inline-block;">
                    <span class="ml15">关闭时间：</span>
                    <input type="number" class="form-control" min="0" value="0" style="display: inline-block;width: 70px;"> 天后
