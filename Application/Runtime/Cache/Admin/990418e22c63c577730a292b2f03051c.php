          ...
          <div class="info-center">
               ...
               <div class="form-group btn-search">
                ...
                <div class="col-md-4">
                 <div class="btn-group pull-right" role="group" aria-label="...">
                  <a type="button" href="<?php echo U('Officweb/navinfo');?>" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span> 新增</a>
            ...
            <div class="clearfix"></div>
              ...
              <table class="table table-bordered table-header">
                 <thead>
                 <tr>
                   <td class="w50">标题名称</td>
                   <td class="w50">URL链接</td>
                   <td>操作</td>
                 </tr>
                 </thead>
                 <tbody>

                <?php if(is_array($datatype)): foreach($datatype as $key=>$v): ?><tr>
                  <td style="font-weight: bold;"><?php echo ($v["navname"]); ?></td>
                  <td><?php echo ($v["navurl"]); ?></td>
                  <td>
                  <a type="button" href="<?php echo U('Officweb/navinfo',array('id'=>$v['navid']));?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span> 编辑</a>
                  </td>
                  <?php foreach ($v['sec'] as $s):?>
                  <tr>
                  <td style="color: #FF9900;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($s["navname"]); ?></td>
                  <td><?php echo ($s["navurl"]); ?></td>
                  <td>
                  <a type="button" href="<?php echo U('Officweb/navinfo',array('id'=>$s['navid']));?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span> 编辑</a>
                  </td>
                  </tr>
                  <?php foreach ($s['thr'] as $t):?>
                  <tr>
                  <td style="color: #008800;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($t["navname"]); ?></td>
                  <td><?php echo ($t["navurl"]); ?></td>
                  <td>
                  <a type="button" href="<?php echo U('Officweb/navinfo',array('id'=>$t['navid']));?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span> 编辑</a>
                  </td>
                  </tr>
                  <?php endforeach;?>
                  <?php endforeach;?>
