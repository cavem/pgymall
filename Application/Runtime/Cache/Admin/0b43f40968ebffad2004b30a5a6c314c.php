          ...
          <div class="info-center">
            ...
            <div class="table-margin">
              <div class="col-lg-6" style="width: 50%">
                <form name="mform" role="form" method="post" action="<?php echo U('officweb/configadd');?>">
                    <div class="form-group" style="white-space:nowrap;">
                        <label>分组编号：<?php echo ($info["id"]); ?></label>
                        <p class="help-block"></p>
                    </div>
                    <div class="form-group" style="white-space:nowrap;">
                        <label>分组名称：</label>
                        <input name="title" value="<?php echo ($info["title"]); ?>">
                        <p class="help-block"></p>
                    </div>
                    <div class="form-group" style="white-space:nowrap;">
                        <label>排序级别：</label>
                        <input type="text" name="px" onkeyup="only_num(this)" onblur="only_num(this)" value="<?php echo ($info["px"]); ?>">
                        <p class="help-block"></p>
                    </div>
                    <div class="form-group" style="white-space:nowrap;">
                        <label>显示属性：</label>
                        <select name="property">
                            <option value="0" <?=empty($info['property'])?"selected":""?>>公开</option>
                            <option value="1" <?=!empty($info['property'])?"selected":""?>>隐藏</option>
                        </select>
                        <p class="help-block"></p>
                    </div>
...
<script type="text/javascript">
    $('document').ready(function(){
        $('#save').click(function(){
            document.mform.action="<?php echo U('officweb/configadd');?>";
