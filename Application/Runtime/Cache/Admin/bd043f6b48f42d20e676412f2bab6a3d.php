...
<form class="mform">
    <div class="form-line fl">
        ...
        <div class="form-content">
            <input class="form-control" type="text" name="smell" value="<?php echo ($smellinfo["smell"]); ?>">
        </div>
    </div>
    <div class="form-line fl">
        <span class="form-label" style="position: relative;bottom: 30px;">执行标准：</span>
        <div class="form-content">
            <textarea class="form-control" rows="3" name="standard"><?php echo ($smellinfo["standard"]); ?></textarea>
        </div>
        <p style="margin-left: 150px;">注：多个执行标准请用“<span style="color: red;">||</span>”隔开</p>
    </div>
</form>
</body>
</html>