    ...
    $(function(){
        $('.semll-add').click(function(){
            var confirm=function(index,layero){
                ...
                $.post('/Admin/Product/smelladd',formdata,function(data,status){
                    if(data==0){
            ...
            myalert('添加香型','900px','400px',"<?php echo U('Product/smelladd');?>",confirm);
        })
        $('.smell-edit').click(function(){
            ...
            var confirm=function(index,layero){
                ...
                var formdata = body.find('.mform').serialize();
                layer.msg('请稍等...',{icon:16});
                $.post('/Admin/Product/smelledit',formdata+"&id="+id,function(data,status){
                    if(data==0){
            ...
            myalert('添加香型','900px','400px',"<?php echo U('Product/smelledit');?>"+"?id="+id,confirm);
        })
    })
</script>
