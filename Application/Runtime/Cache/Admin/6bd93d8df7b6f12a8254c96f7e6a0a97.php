        ...
        <div class="container-fluid">
          <div class="info-center">
            <div class="page-header">
                <div class="pull-left">
						        <h4><a href="<?php echo U('officweb/navlist');?>">导航列表</a>&nbsp;>&nbsp;新增导航</h4>      
					      </div>
            </div>
            <div class="clearfix"></div>
            <div class="table-margin">
              <div class="col-lg-6">
                <form role="form" method="post" action="<?php echo U('officweb/navadd');?>">
                    <div class="form-group">
                        <label>所属类别</label>
                        <select class="form-control" name="fatherid">
                            <option value="-1">--模块类别--</option>
                            <option value="0">--导航一级类别--</option>
                            <?php if(is_array($datatype)): foreach($datatype as $key=>$v): ?><option value="<?php echo ($v["navid"]); ?>" <?=$v['navid']==$info['navfatherid']?'selected':''?>><?php echo ($v["navname"]); ?></option>
                                <?php foreach ($v['sec'] as $s):?>
                                <option value="<?php echo ($s["navid"]); ?>" <?=$s['navid']==$info['navfatherid']?'selected':''?> style="color: #FF9900;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($s["navname"]); ?></option>
                                <?php foreach ($s['thr'] as $t):?>
                                <option value="<?php echo ($t["navid"]); ?>" <?=$t['navid']==$info['navfatherid']?'selected':''?> style="color: #008800;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($t["navname"]); ?></option>
                                <?php endforeach;?>
                    ...
                    <div class="form-group">
                        <label>导航名称</label>
                        <input class="form-control" name="navname" value="<?php echo ($info["navname"]); ?>">
                        <p class="help-block"></p>
                    </div>
                    <div class="form-group">
                        <label>URL链接</label>
                        <input class="form-control" name="navurl"  value="<?php echo ($info["navurl"]); ?>">
                        <p class="help-block">请输入外网可访问到的完整链接</p>
                    </div>
